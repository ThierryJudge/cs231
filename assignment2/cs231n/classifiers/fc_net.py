...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        for i in range(self.num_layers-1):
            self.params['W'+str(i+1)] = np.random.normal(scale=weight_scale, size=(last_dim, hidden_dims[i]))
        ...
        # When using dropout we need to print(self.params['W'+str(i+1)].shape)pass a dropout_param dictionary to each
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers-1):
            if self.normalization=='batchnorm':
                out, cache = affine_batchnorm_relu_forward(out, self.params['W'+str(i+1)], self.params['b'+str(i+1)],
        ...
        dh, grads['W'+str(self.num_layers)], grads['b'+str(self.num_layers)] = affine_backward(dx, caches[-1])
        ...
        for i in reversed(range(self.num_layers-1)):
            ...
            if self.normalization=='batchnorm':
                dh, grads['W'+str(i+1)], grads['b'+str(i+1)], grads['gamma' + str(i+1)], grads['beta' + str(i+1)] = affine_batchnorm_relu_backward(dh, cache)
            else:
                dh, grads['W'+str(i+1)], grads['b'+str(i+1)] = affine_relu_backward(dh, cache)
